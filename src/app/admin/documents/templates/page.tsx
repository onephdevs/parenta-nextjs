...
import DocumentTemplateManager from '@/components/features/DocumentTemplateManager';

export const metadata: Metadata = {
  title: 'Document Templates | Property Management',
  description: 'Create and manage document templates for automated generation',
};
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-md p-6">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">Document Template Tips</h3>
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                <li>Use variables like <code>{"{{tenantName}}"}</code> to create dynamic content</li>
                <li>System templates cannot be deleted but can be cloned for customization</li>
                <li>Templates support HTML for rich formatting and styling</li>
                <li>Required variables must be filled before document generation</li>
                <li>Generated documents can be previewed before final output</li>
              </ul>
            </div>
          </div>
        </div>
