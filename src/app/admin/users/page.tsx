  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <StatCard title="Total Admins" value={stats.total} tone="default" icon={<Users className="h-5 w-5" />} />
        <StatCard title="Active" value={stats.active} tone="green" icon={<UserCheck className="h-5 w-5" />} />
        <StatCard title="Inactive" value={stats.inactive} tone="yellow" icon={<UserX className="h-5 w-5" />} />
      </div>
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        {filteredUsers.length === 0 ? (
          <div className="py-12 text-center">
            ...
            <p className="text-gray-900">No admin users found</p>
          </div>
        ) : (
      ...
      >
        <div className="space-y-4">
          ...
          <FormField label="Username" htmlFor="create-username" hint="Optional. Can be used instead of email to sign in.">
            <Input
              id="create-username"
          ...
          <FormField label="Password" htmlFor="create-password" required hint="At least 8 characters.">
            <Input
              id="create-password"
              type="password"
      ...
      >
        <div className="space-y-4">
          ...
          <FormField label="Status" htmlFor="edit-status">
            <select
              id="edit-status"
              className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <div className="rounded-md border border-gray-200 bg-gray-50 p-3">
            ...
            <div className="space-y-3">
              <FormField label="New password" htmlFor="edit-password" hint="Leave blank to keep the current password.">
                <Input
                  id="edit-password"
                  type="password"
