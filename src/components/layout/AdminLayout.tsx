      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="flex items-center justify-between h-16 bg-white border-b border-gray-200 px-4 lg:px-6">
          ...
          <div className="flex items-center space-x-3">
            <button className="p-2 text-gray-900 hover:text-gray-900 hover:bg-gray-100 rounded-md relative">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button className="p-2 text-gray-900 hover:text-gray-900 hover:bg-gray-100 rounded-md">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
