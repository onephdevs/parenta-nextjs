...
export default function ManualPaymentForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-gray-900">
      <Alert variant="info">
        <strong>Note:</strong> Attach your receipt. A transaction / reference number
        is optional for now. The office confirms before your balance updates.
      </Alert>
      ...
      <div className="flex items-center justify-end space-x-3">
        ...
        <Button
          ...
          isDisabled={!amount || parseFloat(amount) <= 0 || !selectedFile}
