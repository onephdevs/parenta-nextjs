            ...
            {files.map((file) => (
              <div key={file.id} className="relative group">
                <div className={`relative aspect-square rounded-lg overflow-hidden ${
                  ...
                  <div className="absolute inset-0 bg-transparent group-hover:bg-black group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center pointer-events-none group-hover:pointer-events-auto z-20">
                    <IconButton
                      ...
                      className="opacity-0 group-hover:opacity-100 bg-red-500 text-white rounded-full hover:bg-red-600 pointer-events-auto"
                    >
                ...
                <div className="mt-2">
                  ...
                  {file.error && (
                    <Alert variant="danger" className="mt-1 p-2 text-xs">
                      {file.error}
                    </Alert>
                  )}
